...
import com.example.mvvmrecipeapp.presentation.components.HeartAnimationDefinition.HeartButtonState.ACTIVE
import com.example.mvvmrecipeapp.presentation.components.HeartAnimationDefinition.HeartButtonState.IDLE
import com.example.mvvmrecipeapp.presentation.components.HeartAnimationDefinition.heartSize
import com.example.mvvmrecipeapp.presentation.components.HeartAnimationDefinition.heartTransitionDefinition
...
fun AnimatedHeartButton(
    ...
    HeartButton(modifier = modifier, buttonState = buttonState, state = state, onToggle = onToggle)
}
